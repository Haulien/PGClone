...
case $typed in
    1 )
    echo "gd" > /opt/rclone/pgclone.transport ;;
    2 )
    echo "gc" > /opt/rclone/pgclone.transport ;;
    3 )
    echo "sd" > /opt/rclone/pgclone.transport ;;
    4 )
    echo "sc" > /opt/rclone/pgclone.transport ;;
    5 )
    echo "le" > /opt/rclone/pgclone.transport ;;
    * )
        transportselect ;;
esac
}
